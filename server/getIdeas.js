...
const getAPIIdeas = async (schema, query) => {
  ...
  const chain = RunnableSequence.from([
    PromptTemplate.fromTemplate("List 10 Read API ideas that a user could implement based on the given MongoDB Schema in a comma separated list. This is the schema: {schema}.\n{format_instructions}"),
